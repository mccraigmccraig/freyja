defmodule Freyja.Freer.FreerBlock do
  @moduledoc """
  ...
  defmacro defcon(call_ast, do: body),
    do: Freyja.Freer.FreerBlock.Impl.defcon(call_ast, [], body)

  defmacro defcon(call_ast, mods_ast, do: body),
    do: Freyja.Freer.FreerBlock.Impl.defcon(call_ast, mods_ast, body)

  defmacro defconp(call_ast, do: body),
    do: Freyja.Freer.FreerBlock.Impl.defconp(call_ast, [], body)

  defmacro defconp(call_ast, mods_ast, do: body),
    do: Freyja.Freer.FreerBlock.Impl.defconp(call_ast, mods_ast, body)
