defmodule Freyja.Hefty.Effects.HeftyFxListTest do
  ...
  describe "fx_map/2 - comparison with old FxList" do
    # Note: This test demonstrates that HeftyFxList produces same results
    # as old FxList but with dramatically simpler implementation
    test "produces same results as old FxList.fx_map" do
      import Freyja.Con
